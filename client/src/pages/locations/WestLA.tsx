...
import { westLAData } from "@/data/locations/westLA";
import SEO from "@/components/SEO";

export default function WestLA() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <>
      <SEO 
        title="Auto Shop Marketing in West LA | Auto Shop Digital"
        description="West Los Angeles auto shop digital marketing. Expert SEO and Google Ads for Westside auto repair businesses. 90-day guarantee, cancel anytime."
      />
      <Navigation />
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-24">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-primary mb-4">
            ...
            <span className="font-medium">{westLAData.city}, {westLAData.state}</span>
          </div>
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            {westLAData.heroTitle}
          </h1>
          <p className="text-xl text-foreground/80 max-w-3xl mb-8">
            {westLAData.heroSubtitle}
          </p>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-2xl font-bold text-center mb-6">
            Serving West LA and Surrounding Areas
          </h2>
          <div className="flex flex-wrap justify-center gap-3">
            {westLAData.serviceAreas.map((area) => (
      ...
      <section className="py-20">
        <div className="container">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-8">
            Auto Shop Digital Marketing in West LA: Market Overview
          </h2>
          <div className="space-y-6 text-lg text-foreground/80">
            {westLAData.marketOverview.map((paragraph, idx) => (
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">The West LA Auto Market</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {westLAData.marketStats.map((stat, idx) => (
      ...
      <section className="py-20">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">Our Services in West LA</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {westLAData.services.map((service, idx) => (
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">Success Stories from West LA</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {westLAData.testimonials.map((testimonial, idx) => (
              <Card key={idx} className="p-6">
      ...
      <section className="py-20">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {westLAData.whyChooseUs.map((item, idx) => (
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">
            Unique Marketing Challenges for West LA Auto Shops
          </h2>
          <div className="space-y-8">
            {westLAData.challenges.map((challenge, idx) => (
      ...
      <section className="py-20">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {westLAData.serviceAreasDetail.map((area, idx) => (
              <Card key={idx} className="p-6">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="container text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">
            Ready to Dominate West LA Auto Search?
          </h2>
          <p className="text-xl text-foreground/80 max-w-2xl mx-auto mb-8">
            Book a free discovery call to learn how we can help your West LA auto shop attract more customers and grow revenue.
          </p>
          <Button size="lg" onClick={() => { window.location.href = '/get-started'; }} className="bg-primary hover:bg-primary/90">
