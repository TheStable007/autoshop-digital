...
import { torranceData } from "@/data/locations/torrance";
...
export default function Torrance() {
  ...
  return (
    <>
      <SEO 
        title="Auto Shop Marketing in Torrance CA | Auto Shop Digital"
        description="Torrance auto shop SEO and marketing experts. Drive more customers to your South Bay auto repair business. 90-day guarantee, no setup fees."
      />
      <Navigation />
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-24">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-primary mb-4">
            ...
            <span className="font-medium">{torranceData.city}, {torranceData.state}</span>
          </div>
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            {torranceData.heroTitle}
          </h1>
          <p className="text-xl text-foreground/80 max-w-3xl mb-8">
            {torranceData.heroSubtitle}
          </p>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-2xl font-bold text-center mb-6">
            Serving Torrance and Surrounding Areas
          </h2>
          <div className="flex flex-wrap justify-center gap-3">
            {torranceData.serviceAreas.map((area) => (
      ...
      <section className="py-20">
        <div className="container">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-8">
            Auto Shop Digital Marketing in Torrance: Market Overview
          </h2>
          <div className="space-y-6 text-lg text-foreground/80">
            {torranceData.marketOverview.map((paragraph, idx) => (
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">The Torrance Auto Market</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {torranceData.marketStats.map((stat, idx) => (
      ...
      <section className="py-20">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">Our Services in Torrance</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {torranceData.services.map((service, idx) => (
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">Success Stories from Torrance</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {torranceData.testimonials.map((testimonial, idx) => (
              <Card key={idx} className="p-6">
      ...
      <section className="py-20">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {torranceData.whyChooseUs.map((item, idx) => (
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          <h2 className="font-heading text-3xl font-bold text-center mb-12">
            Unique Marketing Challenges for Torrance Auto Shops
          </h2>
          <div className="space-y-8">
            {torranceData.challenges.map((challenge, idx) => (
      ...
      <section className="py-20">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {torranceData.serviceAreasDetail.map((area, idx) => (
              <Card key={idx} className="p-6">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="container text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">
            Ready to Dominate Torrance Auto Search?
          </h2>
          <p className="text-xl text-foreground/80 max-w-2xl mx-auto mb-8">
            Book a free discovery call to learn how we can help your Torrance auto shop attract more customers and grow revenue.
          </p>
          <Button size="lg" onClick={() => { window.location.href = '/get-started'; }} className="bg-primary hover:bg-primary/90">
